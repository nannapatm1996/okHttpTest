...
import static com.github.ppartisan.simplealarms.data.DatabaseHelper.COL_MED;
import static com.github.ppartisan.simplealarms.data.DatabaseHelper.COL_MON;
import static com.github.ppartisan.simplealarms.data.DatabaseHelper.COL_REC;
...
public final class AlarmUtils {
    ...
    public static ContentValues toContentValues(Alarm alarm) {
        ...
        cv.put(COL_MED,alarm.getMed());
      //  cv.put(COL_REC,alarm.getRec());
    ...
    public static ArrayList<Alarm> buildAlarmList(Cursor c) {
        ...
        if (c.moveToFirst()){
            do {
                ...
                final String med = c.getString(c.getColumnIndex(COL_MED));
                //final String rec = c.getString(c.getColumnIndex(COL_REC));

                final Alarm alarm = new Alarm(id, time, label, med);
