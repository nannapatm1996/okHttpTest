...
public final class AlarmsAdapter extends RecyclerView.Adapter<AlarmsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.med.setText(alarm.getMed());
       // holder.rec.setText(alarm.getRec());
    ...
    static final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        final TextView time, amPm, label, days, med;
        ...
        ViewHolder(View itemView) {
            ...
            med = itemView.findViewById(R.id.ar_med);
          //  rec = itemView.findViewById(R.id.ar_rec);
