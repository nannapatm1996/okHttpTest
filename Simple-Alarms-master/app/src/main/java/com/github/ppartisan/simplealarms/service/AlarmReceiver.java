...
import com.github.ppartisan.simplealarms.ui.PresentationActivity;
import com.github.ppartisan.simplealarms.ui.medicineLandingPage;
...
public final class AlarmReceiver extends BroadcastReceiver {
    ...
    public static void setReminderAlarm(Context context, Alarm alarm) {
        ...
        final Intent intent = new Intent(context, AlarmReceiver.class);
         //Intent medintent = new Intent(context, medicineLandingPage.class);
        Intent medintent = new Intent(context, PresentationActivity.class);
        PendingIntent medpintent;
        final Bundle bundle = new Bundle();
        bundle.putParcelable(ALARM_KEY, alarm);
        intent.putExtra(BUNDLE_EXTRA, bundle);
        medintent.putExtra(BUNDLE_EXTRA, bundle);
       ...
       medpintent = PendingIntent.getActivity(context, 0, medintent, 0);

        ScheduleAlarm.with(context).schedule(alarm, medpintent);
