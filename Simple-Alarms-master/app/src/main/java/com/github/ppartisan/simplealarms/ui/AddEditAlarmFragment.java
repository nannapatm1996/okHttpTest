...
public final class AddEditAlarmFragment extends Fragment {
   ...
   // private DatabaseReference mDatabase;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mMed = (EditText) v.findViewById(R.id.editMed);
        mMed.setText(alarm.getMed());

        mRec = (EditText) v.findViewById(R.id.editRecom);
      //  mRec.setText(alarm.getRec());
    ...
    private void save() {
        ...
        alarm.setMed(mMed.getText().toString());
      //  alarm.setRec(mRec.getText().toString());
