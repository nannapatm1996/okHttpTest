...
public final class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_ALTER_ALARM1 = "ALTER TABLE " + TABLE_NAME +" ADD COLUMN " + COL_MED + "string";
    private static final String DATABASE_ALTER_ALARM2 = "ALTER TABLE " + TABLE_NAME +" ADD COLUMN " + COL_REC + "string";
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion){
        Log.d("DBHELPER","Alter Table");
        if (oldVersion < 2 ){
            sqLiteDatabase.execSQL(DATABASE_ALTER_ALARM1);
        }
        if (oldVersion < 3){
            sqLiteDatabase.execSQL(DATABASE_ALTER_ALARM2);
        }
